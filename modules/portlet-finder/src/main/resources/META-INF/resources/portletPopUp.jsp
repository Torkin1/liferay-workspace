...
<div id="<portlet:namespace/>details">
	...
	<div class="content aui-toggler-content-collapsed">
		...
		<br><ul>
			<%
				for (PortletPreferences portletPreference : portletView.getPortletPreferences(themeDisplay.getScopeGroupId())) {
					%>
						<li><%= HtmlUtil.escape(portletPreference.toXmlString()) %></li>
					<%
				}
			%>
		</ul>
